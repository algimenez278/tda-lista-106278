...
int main()
{
	...
	pa2m_afirmar(lista_elemento_en_posicion(lista, 0) == &n0,
		     "El elemento se encuentra en la pos correcta");
	pa2m_afirmar(lista_elemento_en_posicion(lista, 1) == &n1,
		     "El elemento se encuentra en la pos correcta");
	pa2m_afirmar(lista_elemento_en_posicion(lista, 2) == &n2,
		     "El elemento se encuentra en la pos correcta");
	pa2m_afirmar(lista_elemento_en_posicion(lista, 3) == &n3,
		     "El elemento se encuentra en la pos correcta");
